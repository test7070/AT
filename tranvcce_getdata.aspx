        ...
        {   
            ...
            using (System.Data.SqlClient.SqlConnection connSource = new System.Data.SqlClient.SqlConnection(DCConnectionString ))
            {
                ...
                string queryString = @"select recno,seq,datea,ordeno,custno,cust,straddrno,straddr
	                ...
	                ,memo,enda,chk1,chk2
	                ,time1,time2,time3,time4,time5,time6,stype
                from(
            ...
            foreach (System.Data.DataRow r in tranvcce.Rows)
            {
                ...
                tmp.straddrno = System.DBNull.Vablue.Equals(r.ItemArray[6]) ? "" : (System.String)r.ItemArray[6];
                ...
                tmp.stype = System.DBNull.Value.Equals(r.ItemArray[51]) ? "" : (System.String)r.ItemArray[51];
                pout.Add(tmp);
            }
