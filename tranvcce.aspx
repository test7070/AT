                            		...
                            		switch(obj.data('info').value.column2[j].field){
                            			...
                            			case 'carno1':
                            				if(obj.data('info').value.column2[j]['carno1_'+i] == undefined){
	                            				t_apop = [['carno1_'+i, '', 'car2', 'a.noa,driver,a.driverno', '0carno1_'+i+','+'driver1_'+i, 'car2_b.aspx']];
                        				...
                        				case 'carno2':
                            				if(obj.data('info').value.column2[j]['carno2_'+i]== undefined){
	                            				t_apop = [['carno2_'+i, '', 'car2', 'a.noa,driver,a.driverno', '0carno2_'+i+','+'driver2_'+i, 'car2_b.aspx']];
	                            				aPop = aPop.concat(t_apop);
                        				...
                        				case 'carno3':
                            				if(obj.data('info').value.column2[j]['carno3_'+i] == undefined){
	                            				t_apop = [['carno3_'+i, '', 'car2', 'a.noa,driver,a.driverno', '0carno3_'+i+','+'driver3_'+i, 'car2_b.aspx']];
	                            				aPop = aPop.concat(t_apop);
                        				...
                        				case 'carno4':
                            				if(obj.data('info').value.column2[j]['carno4_'+i]== undefined){
	                            				t_apop = [['carno4_'+i, '', 'car2', 'a.noa,driver,a.driverno', '0carno4_'+i+','+'driver4_'+i, 'car2_b.aspx']];
	                            				aPop = aPop.concat(t_apop);
                        				...
                        				case 'carno5':
                            				if(obj.data('info').value.column2[j]['carno5_'+i] == undefined){
	                            				t_apop = [['carno5_'+i, '', 'car2', 'a.noa,driver,a.driverno', '0carno5_'+i+','+'driver5_'+i, 'car2_b.aspx']];
	                            				aPop = aPop.concat(t_apop);
                        				...
                        				case 'carno6':
                            				if(obj.data('info').value.column2[j]['carno6_'+i] == undefined){
	                            				t_apop = [['carno6_'+i, '', 'car2', 'a.noa,driver,a.driverno', '0carno6_'+i+','+'driver6_'+i, 'car2_b.aspx']];
	                            				aPop = aPop.concat(t_apop);
