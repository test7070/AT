	...
	<head>
		...
		<script type="text/javascript">
            aPop = new Array(
            	...
            	['txtBrokerno', '', 'broker', 'noa,namea', 'txtBrokerno', 'broker_b.aspx'],
            ...
            function q_seekStr() {
				...
				t_brokerno = $('#txtBrokerno').val();
                var t_where = " 1=1 " 
                	+ q_sqlPara2("noa", t_noa) 
                	+ q_sqlPara2("productno", t_productno) 
					+ q_sqlPara2("brokerno", t_brokerno);
                if (t_addr.length > 0)
                    t_where += " and charindex('" + t_addr + "',addr)>0";
                if(t_custno.length>0)
		       		t_where += " and exists(select noa from addrs where addrs.noa=addr.noa and addrs.custno='"+t_custno+"')";
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
                    <td class='seek'  style="width:20%;"><a id='lblBrokerno'></a></td>
                    <td><input class="txt" id="txtBrokerno" type="text" style="width:215px; font-size:medium;" /></td>
                </tr>
				<tr class='seek_tr'>
