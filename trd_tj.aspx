            ...
            function q_gtPost(t_name) {
                switch (t_name) {
                    ...
                    case 'trd_tran_rj':
                        ...
                        q_gridAddRow(bbsHtm, 'tbbs', 'txtTrandate,txtTranaccy,txtTranno,txtTrannoq,txtCarno,txtStraddr,txtEndaddr,txtTranmoney,txtCaseno,txtCaseno2,txtMount,txtPrice,txtTotal,txtProduct', as.length, as, 'trandate,accy,noa,noq,carno,straddr,endaddr,custmoney,caseno,caseno2,mount,custprice,custmoney,product', '', '');
                        for ( i = 0; i < q_bbsCount; i++) {
                            if (i < as.length) {
                            } else {
                                _btnMinus("btnMinus_" + i);
