	...
	<head>
		...
		<script type="text/javascript">
            ...
            function _btnSeek() {
                ...
                q_box('cust_at_s.aspx', q_name + '_s', "550px", "600px", q_getMsg("popSeek"));
            }
            function btnIns() {
                _btnIns();
                refreshBbm();
			...
			<div class="dbbm">
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td>
							<input id="txtPaytype" type="text" style="float:left; width:85%;"/>
							<select id="combPaytype" style="float:left; width:15%;"></select>
						</td>
					</tr>
					<tr>
